<?php
    ...
    if (isset($_POST['first-name']) && isset($_POST['your-email'])) {
        ...
        $mail->Body = "Name: $fname, $lname <br> Email: $email <br> Phone: $phone <br> Job Title: $jobtitle <br> Country: $country <br> Intended Use: $usage <br><br>--<br>This e-mail was sent from a contact form on Lucy Security";
